...
// the same table.
//
// Constellation fork: this replaces upstream's single-reflector
// NewPodTableAndReflector (PodTableCell in pods.go provides it). It lives here
// beside the node watcher so pods.go stays close to upstream.
