...
func TestManagedScope_AllocateNext_PoolRouting(t *testing.T) {
	...
	if !netip.MustParsePrefix("10.0.1.0/24").Contains(r1.IP) {
	...
	if !netip.MustParsePrefix("10.0.2.0/24").Contains(r2.IP) {
	...
	if !netip.MustParsePrefix("10.0.0.0/24").Contains(r3.IP) {
...
func TestManagedScope_AllocateNext_UnknownPoolFallback(t *testing.T) {
	...
	if !netip.MustParsePrefix("10.0.0.0/24").Contains(result.IP) {
...
func TestManagedScope_AllocateOutOfRange(t *testing.T) {
	...
	_, err := m.Allocate(netip.MustParseAddr("192.168.0.1"), "owner", PoolDefault())
	if err == nil {
...
func TestManagedScope_ReleaseOutOfRange(t *testing.T) {
	...
	err := m.Release(netip.MustParseAddr("192.168.0.1"), PoolDefault())
	if err == nil {
...
func TestManagedScope_AddCIDR_Dynamic(t *testing.T) {
	...
	if !netip.MustParsePrefix("10.0.5.0/24").Contains(result.IP) {
	...
	if !netip.MustParsePrefix("10.0.6.0/24").Contains(result2.IP) {
...
func TestManagedScope_AddCIDR_UpdateExisting(t *testing.T) {
	...
	if !netip.MustParsePrefix("10.0.5.0/24").Contains(r2.IP) {
